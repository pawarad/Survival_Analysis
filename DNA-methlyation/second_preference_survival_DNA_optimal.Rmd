...
#### This script uses the DNA-methylation(PAAD) and PAAD clinical data from TCGA to analyse survival of the patients. We are using Elastic net multivariate anlaysis to calculate survival and plot Kaplan Meier plots based on Dr. Manne's gene panel (chemoresistance). The alpha used for this script is calculated based on the lowest mean error and the minimum lambda value accordinly for every iteration(100 iterations to calculate best value for alpha and lambda). We have done 100 different iterations.
